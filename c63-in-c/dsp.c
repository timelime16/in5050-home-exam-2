...
)
{
  ...
  buf0 = foo(r0, dct1, dct2);
  buf1 = foo(r1, dct1, dct2);
  buf2 = foo(r2, dct1, dct2);
  buf3 = foo(r3, dct1, dct2);
  buf4 = foo(r4, dct1, dct2);
  buf5 = foo(r5, dct1, dct2);
  buf6 = foo(r6, dct1, dct2);
  buf7 = foo(r7, dct1, dct2);
